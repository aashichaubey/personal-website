    ...
    return (
        <div className="projects">
            ...
            <ul className="projects-list">
                <li className="fade-in" style={{ animationDelay: '850ms' }}><span className="project-icon">&#x21B3;</span> brain v2 <span className="project-description"> - memory bank for ai agents (1st of 1,450+ hackers, shopify)</span></li>
                ...
                <li className="fade-in" style={{ animationDelay: '1350ms' }}><span className="project-icon">&#x21B3;</span> <a href="https://devpost.com/software/spine-guard" className="project-link">spine guard </a> <span className="project-description"> - wearable posture tracker (best healthtech hack, 600+ hackers)</span></li>
